...
### `red В качестве оптимального решения для крупной компании я предлагаю использование платформы оркестрации **Kubernetes (K8s)**. На сегодняшний день это промышленный стандарт, обладающий самой развитой экосистемой и полностью закрывающий потребности микросервисной архитектуры. `
